...
/**
 * A helper class for {@link androidx.paging.PagedList.BoundaryCallback BaseBoundaryCallback}s and
 ...
 * <pre>
 * class PagingBoundaryCallback extends PagedList.BaseBoundaryCallback&lt;MyItem> {
...
public class PagingRequestHelper {
    ...
    public enum RequestType {
         ...
         * a {@link androidx.paging.PagedList.BoundaryCallback BaseBoundaryCallback}.
         */
        INITIAL,
        /**
         * Corresponds to the {@code loadBefore} calls in {@link DataSource} or
         * {@code onItemAtFrontLoaded} in
         * {@link androidx.paging.PagedList.BoundaryCallback BaseBoundaryCallback}.
         */
        BEFORE,
        /**
